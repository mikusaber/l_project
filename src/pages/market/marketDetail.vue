 ...
 * @LastEditTime: 2022-06-15 16:00:03
...
<template>
  <div class="marketDetail" v-if="state.detailObj">
    ...
    <div class="marketDetail_bottom">
      ...
      <van-button v-else class="gray-btn" block disabled>
        <span class="btn-text">
          {{ state.detailObj.StatusText }}</span
        ></van-button
      >
      <!-- <div class="right"></div> -->
    </div>
...
const Buy = async () => {
  try {
    let params = {
      action: "SubmitOrder",
      MemberProductId: state.detailObj.Id,
    };
